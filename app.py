...
# Dark mode input fields and text
custom_dark_style = """
<style>
/* Input fields */
...
body, .stTextInput label, .stNumberInput label, .stSelectbox label, .stMarkdown {
    color: #ffffff !important;
}
...
"""
st.markdown(custom_dark_style, unsafe_allow_html=True)
